import {
  ...
  IntegerLiteralCtx,
  LiteralCtx, MethodDeclarationCtx, MethodDeclaratorCtx, NormalInterfaceDeclarationCtx, TypeIdentifierCtx
} from 'java-parser';

export class TestVisitor extends BaseJavaCstVisitorWithDefaults {
